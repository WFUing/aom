...
export async function setRootFolder(fileName: string, services: LangiumSharedServices, root?: string): Promise<void> {
    if (!root) {
    ...
    await services.workspace.WorkspaceManager.initializeWorkspace(folders);
}
